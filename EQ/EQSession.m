...
- (void)initializeDataSynchronization{
    self.updateTimer = [[NSTimer alloc] initWithFireDate:[NSDate dateWithTimeIntervalSinceNow:(MAXIMUM_MINUTES_TO_UPDATE * 60)] interval:(MAXIMUM_MINUTES_TO_UPDATE * 60) target:[EQDataManager sharedInstance] selector:@selector(checkIfNeedSendData) userInfo:nil repeats:YES];
